...
subject to ingresoApoyos02{d in D, t in TMJ6}: YMJLV30[d,t] = YMJLV30[d-1,t] + YmasMJLV30[d,t] - YmenMJLV30[d,t] ;
subject to ingresoApoyos03{d in D, t in TPT9}: YPTSD18[d,t] = YPTSD18[d-1,t] + YmasPTSD18[d,t] - YmenPTSD18[d,t] ;

#subject to condicionInicial1{t in TMJ6X1, r in REV}: YMJ6X1[0,t,r] = 0 ;
subject to condicionInicial01{t in TFT9}: YFTLV45[0,t] = 0 ;
subject to condicionInicial02{t in TMJ6}: YMJLV30[0,t] = 0 ;
subject to condicionInicial03{t in TPT9}: YPTSD18[0,t] = 0 ;
...
subject to ingresoDiasHabiles02{d in D, t in TMJ6}: YmasMJLV30[d,t] <= INGRESO[d]*M ;
subject to ingresoDiasHabiles03{d in D, t in TPT9}: YmasPTSD18[d,t] <= INGRESO[d]*M ;
...
subject to salidaDiasHabiles02{d in D, t in TMJ6}: YmenMJLV30[d,t] <= SALIDA[d]*M ;
subject to salidaDiasHabiles03{d in D, t in TPT9}: YmenPTSD18[d,t] <= SALIDA[d]*M ;
...
subject to minRotativos{d in D}:
   (sum{h in H, t in TFT9, r in R} YFT4D45[d,t,r] + 
    sum{h in H, t in TFT9, r in R} YFT7D45[d,t,r] + 
    sum{h in H, t in TFT8, r in R} YFT4D40[d,t,r] + 
    sum{h in H, t in TFT8, r in R} YFT7D40[d,t,r] + 
    sum{h in H, t in TMJ6, r in R} YMJ4D30[d,t,r] + 
    sum{h in H, t in TMJ6, r in R} YMJ7D30[d,t,r] + 
    sum{h in H, t in TMJ5, r in R} YMJ4D25[d,t,r] + 
    sum{h in H, t in TMJ5, r in R} YMJ7D25[d,t,r] ) >= 46 ;
